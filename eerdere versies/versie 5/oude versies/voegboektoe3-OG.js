// deze versie gebruikt de camera van je mobiel
...
document.getElementById("scanBtn").addEventListener("click", () => {
  ...
  Quagga.init({
    inputStream: {
      ...
      target: scannerDiv,
      constraints: {
        facingMode: "environment" // achtercamera op mobiel
      }
    },
    decoder: {
      readers: ["ean_reader"] // ISBN-13 = EAN-13
    }
  }, err => {
    if (err) {
      console.error(err);
...
Quagga.onDetected(result => {
  ...
  // ISBN-13 begint meestal met 978 of 979
